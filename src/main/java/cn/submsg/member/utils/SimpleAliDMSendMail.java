package cn.submsg.member.utils;
import javax.mail.*;
...
public class SimpleAliDMSendMail {
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        // 发件人的账号
        props.put("mail.user", "submsg@submsg.cn");
        // 访问SMTP服务时需要提供的密码
        props.put("mail.password", "Aa222222");
        
        String nick="";  
        try {  
            nick=javax.mail.internet.MimeUtility.encodeText("SUBMSG");  
        ...
        // 设置收件人
        InternetAddress to = new InternetAddress("dogdog7788@qq.com");
